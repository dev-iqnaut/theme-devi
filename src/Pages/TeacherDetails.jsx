  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center">
       ...
       <p className="text-xs sm:text-sm mt-5 font-medium">Home <span className="text-[#FE6440]">//</span> Teacher Details</p>
       </div>
      </div>
      {/* details */}
      <div className="flex flex-col md:flex-row justify-center items-center w-full h-full ">
        ...
        <div className="p-5 bg-white w-full m-5">
          <div className="p-4">
          <h1 className="text-2xl font-semibold">Ann Dooley</h1>
          <span className="text-red-500">Teacher</span>
          <p className="mt-4 text-gray-800 text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi dolorum deserunt, fugiat vero doloremque cupiditate quis, fugit ullam reiciendis numquam unde et! Dolorem, hic nemo autem maxime cupiditate ullam nisi.</p>
          <p  className="mt-3 text-gray-800 text-sm">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nobis dignissimos voluptates eaque, officia doloribus nostrum tenetur debitis quod ipsa? Sapiente vitae minima molestiae maiores?</p>
          <h2 className="mt-4 font-semibold text-xl">Education</h2>
          <p className="mt-3 text-sm text-gray-800">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Delectus aliquid perferendis tempora nesciunt ducimus sit dicta facilis omnis.</p>
          <h2 className="mt-4 font-semibold text-xl">Expertise and Skills</h2>
